    ...
    <div className="contact py-20 sm:px-32 px-10">
      ...
      <div className="text-white flex flex-col md:flex-row gap-10 md:gap-20">
        ...
        <div className="w-full md:w-[45%] flex flex-col relative">
          ...
          />
          <div className="flex flex-col gap-5 items-center absolute bottom-10 w-full md:w-auto md:items-start">
            ...
            <div className="flex items-center gap-5 justify-center md:justify-start z-50">
