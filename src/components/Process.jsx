...
const Process = () => {
  ...
  return (
    <div
      ...
      className="process bg-cover bg-center h-screen relative flex flex-col items-center"
    >
      <div className="processSide py-10 text-center max-sm:hidden">
        <h2 className="text-[#65C6B9] text-4xl sm:text-5xl md:text-6xl">
      ...
      <div className="absolute top-8 left-8 sm:left-16 md:left-52 w-[90%] sm:w-[80%] md:w-[65%] text-white flex flex-col justify-between gap-16 sm:gap-20 md:gap-52">
        ...
        <div className="flex flex-col gap-5 sm:gap-8 md:gap-10">
          <h3 className="text-3xl sm:text-4xl md:text-6xl font-bold w-full">
            {stepsData[currIndex]?.title}
          </h3>
          <p className="text-lg sm:text-2xl md:text-3xl opacity-70">
